    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('approved', 'APPROVED'), ('unapproved', 'UNAPPROVED'), ('decline', 'DECLINED'),('APPLY', 'APPLY')], default='Not Approved', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.CharField(max_length=254, verbose_name='email address')),
